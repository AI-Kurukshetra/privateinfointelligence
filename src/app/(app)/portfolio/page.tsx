    ...
    <div className="ui-page">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <SectionCard title="Add Portfolio Company" subtitle="Core portfolio management record">
          <form action={createPortfolioCompany} className="flex flex-1 flex-col gap-4">
            ...
            <div className="mt-auto pt-2">
              <SubmitButton loadingText="Saving…" className="w-full">Save Company</SubmitButton>
            </div>
          </form>
        </SectionCard>

        <SectionCard title="Deal Pipeline" subtitle="From sourcing through diligence and close">
          <form action={createDeal} className="flex flex-1 flex-col gap-4">
            <div className="ui-form-grid two">
            ...
            <div className="mt-auto pt-2">
              <SubmitButton loadingText="Saving…" className="w-full">Save Deal</SubmitButton>
            </div>
          </form>
        </SectionCard>

        <SectionCard title="Add Investment" subtitle="Track invested amount and ownership">
          <form action={createInvestment} className="flex flex-1 flex-col gap-4">
            <div className="ui-form-grid two">
            ...
            <div className="mt-auto pt-2">
              <SubmitButton loadingText="Saving…" className="w-full">Save Investment</SubmitButton>
            </div>
          </form>
        </SectionCard>

        <SectionCard title="Add Valuation" subtitle="Methodology and publication workflow">
          <form action={createValuation} className="flex flex-1 flex-col gap-4">
            <div className="ui-form-grid two">
            ...
            <div className="mt-auto pt-2">
              <SubmitButton loadingText="Saving…" className="w-full">Save Valuation</SubmitButton>
            </div>
          </form>
        </SectionCard>
      </div>
